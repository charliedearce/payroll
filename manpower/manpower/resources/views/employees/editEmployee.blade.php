...
<div class="row">
	<div class="col s12">
		<div class="card-panel hoverable" style="background-image:url('http://materializecss.com/images/sample-1.jpg'); width: 100%; height: 100%;"><h3 class="white-text">Edit Employee</h3>
		</div>
	</div>
</div>
	      ...
	      <div class="row">
			...
			<div class="input-field col s6">
				<select name="position">
			      <option value="" disabled selected>Choose Employee Position</option>
