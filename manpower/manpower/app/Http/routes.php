...
Route::get('/home/pdfEmployee/{empid}', 'EmployeeController@pdfEmployee');
Route::get('/home/imageEmployee/{filename}', ['uses' => 'EmployeeController@getImage','as' => 'employee.image']);

Route::get('/home/payroll/attendance/{payrollid}/{empid}', 'payrollController@viewAttendance');
Route::post('/home/payroll/attendance/{payrollid}/{empid}/addAttendance', 'payrollController@addAttendance');
